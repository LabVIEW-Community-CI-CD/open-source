...
Run the JavaScript tests and generate traceability data with:
...
JUnit files appear under `test-results/`. Commit `test-results/*` and `artifacts/linux/*` along with source changes.
