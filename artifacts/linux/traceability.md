...
| Unmapped | errors-when-strict-unmapped-mode-enabled | Passed | 1.204 |  |  |
| Unmapped | escapemarkdown-escapes-special-characters | Passed | 0.006 |  |  |
...
| Unmapped | fails-when-no-junit-files-are-found | Passed | 1.086 |  |  |
| Unmapped | fails-when-requirement-lacks-test-coverage | Passed | 1.324 |  |  |
| Unmapped | fails-when-tests-are-unmapped | Passed | 1.170 |  |  |
| Unmapped | fails-when-tests-reference-unknown-requirements | Passed | 1.047 |  |  |
...
| Unmapped | groups-owners-and-includes-requirements-and-evidence | Passed | 1.175 |  |  |
| Unmapped | grouptomarkdown-omits-numeric-identifiers | Passed | 0.011 |  |  |
| Unmapped | grouptomarkdown-supports-optional-limit-for-truncation | Passed | 0.006 |  |  |
| Unmapped | handles-root-level-testcases | Passed | 0.001 |  |  |
| Unmapped | handles-zipped-junit-artifacts | Passed | 0.934 |  |  |
| Unmapped | ignores-stale-junit-files-outside-artifacts-path | Passed | 0.920 |  |  |
...
| Unmapped | partitions-requirement-groups-by-runner\_type | Passed | 0.898 |  |  |
| Unmapped | passes-with-coverage-and-requirement-reference | Passed | 1.066 |  |  |
| Unmapped | requirementssummarytomarkdown-escapes-pipes-in-description | Passed | 0.001 |  |  |
| Unmapped | skips-invalid-junit-files-and-still-generates-summary | Passed | 1.222 |  |  |
| Unmapped | summarytomarkdown-handles-no-tests | Passed | 0.005 |  |  |
| Unmapped | summarytomarkdown-sorts-os-alphabetically-and-escapes-special-characters | Passed | 0.001 |  |  |
| Unmapped | throws-when-no-junit-files-found-and-strict-mode-enabled | Passed | 0.818 |  |  |
| Unmapped | uses-latest-artifact-directory-when-multiple-are-present | Passed | 1.059 |  |  |
| Unmapped | warns-when-all-tests-are-unmapped | Passed | 1.199 |  |  |
...
| Unmapped | writes-outputs-to-os-specific-directory | Passed | 1.587 |  |  |
