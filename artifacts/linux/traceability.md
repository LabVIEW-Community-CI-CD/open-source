...
| Requirement | Test ID | Status | Duration (s) | Owner | Evidence |
| --- | --- | --- | --- | --- | --- |
| REQ-032 | preserves-unknown-attributes | Passed | 0.006 |  |  |
...
| Unmapped | errors-when-strict-unmapped-mode-enabled | Passed | 0.856 |  |  |
...
| Unmapped | fails-when-requirement-lacks-test-coverage | Passed | 0.965 |  |  |
| Unmapped | fails-when-tests-are-unmapped | Passed | 0.858 |  |  |
| Unmapped | fails-when-tests-reference-unknown-requirements | Passed | 0.850 |  |  |
...
| Unmapped | groups-owners-and-includes-requirements-and-evidence | Passed | 0.923 |  |  |
...
| Unmapped | handles-zipped-junit-artifacts | Passed | 0.804 |  |  |
| Unmapped | ignores-stale-junit-files-outside-artifacts-path | Passed | 0.780 |  |  |
| Unmapped | loadrequirements-logs-warning-on-invalid-json | Passed | 0.035 |  |  |
| Unmapped | loadrequirements-merges-multiple-files | Passed | 0.020 |  |  |
| Unmapped | loadrequirements-warns-and-skips-invalid-entries | Passed | 0.015 |  |  |
| Unmapped | logs-a-warning-when-no-junit-files-are-found | Passed | 0.900 |  |  |
| Unmapped | partitions-requirement-groups-by-runner\_type | Passed | 0.724 |  |  |
| Unmapped | passes-with-coverage-and-requirement-reference | Passed | 0.832 |  |  |
...
| Unmapped | uses-latest-artifact-directory-when-multiple-are-present | Passed | 0.808 |  |  |
| Unmapped | warns-when-all-tests-are-unmapped | Passed | 1.059 |  |  |
...
| Unmapped | writes-outputs-to-os-specific-directory | Passed | 1.139 |  |  |
