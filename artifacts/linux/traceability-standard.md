...
| Requirement | Test ID | Status | Duration (s) | Owner | Evidence |
| --- | --- | --- | --- | --- | --- |
| REQ-032 | preserves-unknown-attributes | Passed | 0.009 |  |  |
...
| Unmapped | fails-when-commit-lacks-requirement-reference | Passed | 1.041 |  |  |
| Unmapped | fails-when-no-junit-files-are-found | Passed | 0.900 |  |  |
| Unmapped | fails-when-requirement-lacks-test-coverage | Passed | 1.203 |  |  |
...
| Unmapped | groups-owners-and-includes-requirements-and-evidence | Passed | 1.032 |  |  |
...
| Unmapped | handles-zipped-junit-artifacts | Passed | 0.705 |  |  |
| Unmapped | ignores-stale-junit-files-outside-artifacts-path | Passed | 0.702 |  |  |
| Unmapped | loadrequirements-logs-warning-on-invalid-json | Passed | 0.011 |  |  |
| Unmapped | loadrequirements-warns-and-skips-invalid-entries | Passed | 0.019 |  |  |
| Unmapped | partitions-requirement-groups-by-runner\_type | Passed | 0.688 |  |  |
| Unmapped | passes-with-coverage-and-requirement-reference | Passed | 0.926 |  |  |
| Unmapped | requirementssummarytomarkdown-escapes-pipes-in-description | Passed | 0.000 |  |  |
| Unmapped | skips-invalid-junit-files-and-still-generates-summary | Passed | 1.115 |  |  |
...
| Unmapped | throws-when-no-junit-files-found-and-strict-mode-enabled | Passed | 0.636 |  |  |
| Unmapped | uses-latest-artifact-directory-when-multiple-are-present | Passed | 0.823 |  |  |
| Unmapped | warns-when-all-tests-are-unmapped | Passed | 0.999 |  |  |
...
| Unmapped | writes-outputs-to-os-specific-directory | Passed | 1.432 |  |  |
